...
export const FileViewIcon = ({
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" className={className} {...props}>
      <g fill={fill} stroke={color} strokeLinejoin="round" strokeWidth={strokeWidth}>
        ...
        <path strokeWidth="1.5" d="M16 22c2.761 0 5-3 5-3s-2.239-3-5-3s-5 3-5 3s2.239 3 5 3Z" />
